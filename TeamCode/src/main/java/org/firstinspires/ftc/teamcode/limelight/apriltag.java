...
public class apriltag extends LinearOpMode
{
    ...
    final double DESIRED_DISTANCE = 74.9;
    final double DESIRED_HEADING = 7;
    final double DESIRED_ROBOT_HEADING = -11;
    ...
    public AprilTagLibrary.Builder myAprilTagLibraryBuilder;
    public AprilTagProcessor.Builder myAprilTagProcessorBuilder;
    public AprilTagLibrary myAprilTagLibrary;
    ...
    @Override public void runOpMode()
    {
        ...
        if (USE_WEBCAM)
            setManualExposure(10, 220);  // Use low exposure time to reduce motion blur
        ...
        while (opModeIsActive())
        {
            ...
            if (gamepad1.left_bumper && targetFound) {
                ...
                double  headingError    = (desiredTag.ftcPose.bearing + DESIRED_ROBOT_HEADING);
                double  yawError        = (desiredTag.ftcPose.yaw - DESIRED_HEADING);
